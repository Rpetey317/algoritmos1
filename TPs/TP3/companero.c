...
void preguntar_transporte(char* respuesta){ 
    ...
    printf("Trineo (%c), Nave espacial (%c), Mac el camión (%c), Alfombra voladora (%c)\n", TRINEO, NAVE, CAMION, ALFOMBRA);
    scanf(" %c", respuesta);
...
void preguntar_marcha(char* respuesta){
    ...
    printf("Ingrese su respuesta\nEstas son las respuestas posibles: ");
    printf("Bolas de nieve (%c), Pistolita pium pium (%c), KUCHAU! (%c), Genio de la lámpara (%c)\n", BOLAS_DE_NIEVE, PIUM_PIUM, KUCHAU, GENIO);
    scanf(" %c", respuesta);
    *respuesta = (char) toupper(*respuesta);
    printf("%s", SEPARADOR);
...
void imprimir_personaje(char personaje){
    ...
    switch(personaje){
        case OLAF:
            ...
            printf("Olaf te enseñó el arte de la bola de nieve, que puede calmar incendios... (en tu mente y en la vida real");
            break;
        ...
        case STITCH:
            ...
            printf("Jugando con las pistolitas de Stitch un disparo perdido entró a un aula. Parece que quemó un papel...");
            break;
        ...
        case JASMIN:
            ...
            printf("Le caíste bien al Genio. Te concedió como deseo harramientas para tu próxima aventura...");
            break;
        ...
        case MCQUEEN:
            ...
            printf("Gracias al Rayo eres MAS VELOZ y te cansas más lento");
            break;
...
void jugar_tp1(char* personaje){
    ...
    *personaje = obtener_personaje(transporte, marcha, hora, nota);
